...
func evalPrefixExpression(operator string, right object.Object) object.Object {
	switch operator {
	case "!":
		return evalBangOpertatorExpression(right)
	case "-":
		return evalMinusPrefixOpertatorExpression(right)
	default:
		return newError("unknown operator: %s%s", operator, right.Type())
	}
}

func evalBangOpertatorExpression(right object.Object) object.Object {
	switch right {
	case TRUE:
		return FALSE
	case FALSE:
...
func evalMinusPrefixOpertatorExpression(right object.Object) object.Object {
...
func evalHashLiteral(
	...
	for keyNode, valueNode := range node.Pairs {
		...
		hashsed := hashKey.HashKey()
		pairs[hashsed] = object.HashPair{Key: key, Value: value}
	}
